      ...
      <div class="col-sm-6">
        <div class="card run-buddy-card">
          <div class="card-body project-information">
            ...
            <h5 class="card-title light-color fw-bold">Run Buddy</h5>
            </a>
        ...
        <div class="card stay-protected-card">
          <div class="card-body project-information">
            ...
            <h5 class="card-title light-color fw-bold">Password Generator</h5>
            </a>
        ...
        <div class="card fitness-tracker-card">
          <div class="card-body project-information">
            ...
            <h5 class="card-title light-color fw-bold">Fitness Tracker</h5>
            </a>
        ...
        <div class="card art-of-jenna-card">
          <div class="card-body project-information">
            ...
            <h5 class="card-title light-color fw-bold">Art Of Jenna Louise</h5>
            </a>
        ...
        <div class="card book-search-card">
          <div class="card-body project-information">
            ...
            <h5 class="card-title light-color fw-bold">Book Search</h5>
            </a>
